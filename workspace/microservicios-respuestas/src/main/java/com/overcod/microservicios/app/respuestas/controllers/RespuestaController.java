package com.overcod.microservicios.app.respuestas.controllers;
...
import com.overcod.microservicios.app.respuestas.services.RespuestaService;
...
public class RespuestaController {
	...
	public ResponseEntity<?> obtenerExamenesIdsConRespuestasAlumno(@PathVariable Long alumnoId) {
		Iterable<Long> examenesIds = service.findExamenesIdConRespuestasByAlumno(alumnoId);
